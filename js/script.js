...
function randomParagraph(){
    // geeting random number and it'll always less than the paragraphs length
    let randIndex = Math.floor(Math.random() * paragraphs.length);
    typingText.innerHTML = "";
    // getting random item from the paragraphs array, splitting all characters
    //  of it, addding each character inside span and then adding this span inside p tag
    ...
    if( characters[charIndex].classList.contains("incorrect")){
       ...
       characters[charIndex].classList.remove("correct", "incorrect")
        ...
        if(characters[charIndex].innerText === typedChar){
            ...
            // correct class else increment the mistake and add the incorrect class
